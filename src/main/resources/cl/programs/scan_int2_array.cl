__kernel void scan_int2_single_block(__global int2 *data, 
                                     __local int2 *buffer, 
                                     int n) 
{
...
__kernel void scan_int2_multi_block(__global int2 *data, 
                                    __local int2 *buffer, 
                                    __global int2 *part, 
                                    int n)
{
...
__kernel void complete_int2_multi_block(__global int2 *data, 
                                        __local int2 *buffer, 
                                        __global int2 *part, 
                                        int n)
{
