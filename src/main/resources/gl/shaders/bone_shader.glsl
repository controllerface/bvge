#type vertex
#version 330 core
layout (location = 0) in vec2 aTransform;
...
void main()
{
    vec2 position = vertex_data[0].transform;
...
void main()
{
    vec4 circleColor = vec4(0.761, 0.698, 0.502, 1);
    float thickness = 1;
    float fade = .0005;
