...
public class HarrisTest
{
    ...
    private static void recursive_scan(cl_mem d_data, int[] output, int n)
    {
        ...
        if (k == 1)
        {
            ...
            Pointer nb_data2 = Pointer.to(d_partial);
            ...
            clSetKernelArg(k_scan_subarrays, 2, Sizeof.cl_mem, nb_data2);
...
//            k1 += clw.run_kernel_with_timing(scan_subarrays, /*dim=*/1, &gx, &wx);
            ...
            recursive_scan(d_partial, output, n - gx);
//            recursive_scan(d_partial, k);
            ...
            clSetKernelArg(k_scan_inc_subarrays, 2, Sizeof.cl_mem, nb_data2);
