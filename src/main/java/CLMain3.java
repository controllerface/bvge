    ...
    public static void main(String[] args) {
        ...
        String source =
            "#define BLOCK_SIZE 256\n" +
                ...
                "    int lblock = lid / 2;\n" +
                "    int offset = 1;\n" +
                "    int ai = lblock * 2 * BLOCK_SIZE + (lid % 2) * offset - 1;\n" +
                "    int bi = ai + offset;\n" +
                "    temp[ai] = (gid < n) ? input[gid] : 0;\n" +
                "    temp[bi] = (gid + lsize < n) ? input[gid + lsize] : 0;\n" +
        ...
        CL.clSetKernelArg(scanKernel, 3, Sizeof.cl_int * (2 * 256), null);
