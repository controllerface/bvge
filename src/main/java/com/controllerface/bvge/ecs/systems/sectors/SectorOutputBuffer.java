...
public class SectorOutputBuffer
{
    ...
    private final UnorderedSectorGroup sector_buffer;
    ...
    public SectorOutputBuffer(long ptr_queue, GPUCoreMemory core_memory)
    {
        ...
        this.sector_buffer     = new UnorderedSectorGroup(this.ptr_queue, ENTITY_CAP, HULL_CAP, EDGE_CAP, POINT_CAP);
        p_gpu_crud.init();
        ...
        k_egress_entities = new EgressEntities_k(GPGPU.ptr_compute_queue, k_ptr_egress_candidates)
            ...
            .buf_arg(EgressEntities_k.Args.points_out,                      sector_buffer.get_buffer(BufferType.POINT))
            .buf_arg(EgressEntities_k.Args.point_vertex_references_out,     sector_buffer.get_buffer(BufferType.POINT_VERTEX_REFERENCE))
            .buf_arg(EgressEntities_k.Args.point_hull_indices_out,          sector_buffer.get_buffer(BufferType.POINT_HULL_INDEX))
            .buf_arg(EgressEntities_k.Args.point_hit_counts_out,            sector_buffer.get_buffer(BufferType.POINT_HIT_COUNT))
            .buf_arg(EgressEntities_k.Args.point_flags_out,                 sector_buffer.get_buffer(BufferType.POINT_FLAG))
            .buf_arg(EgressEntities_k.Args.point_bone_tables_out,           sector_buffer.get_buffer(BufferType.POINT_BONE_TABLE))
            .buf_arg(EgressEntities_k.Args.edges_out,                       sector_buffer.get_buffer(BufferType.EDGE))
            .buf_arg(EgressEntities_k.Args.edge_lengths_out,                sector_buffer.get_buffer(BufferType.EDGE_LENGTH))
            .buf_arg(EgressEntities_k.Args.edge_flags_out,                  sector_buffer.get_buffer(BufferType.EDGE_FLAG))
            .buf_arg(EgressEntities_k.Args.hulls_out,                       sector_buffer.get_buffer(BufferType.HULL))
            .buf_arg(EgressEntities_k.Args.hull_scales_out,                 sector_buffer.get_buffer(BufferType.HULL_SCALE))
            .buf_arg(EgressEntities_k.Args.hull_rotations_out,              sector_buffer.get_buffer(BufferType.HULL_ROTATION))
            .buf_arg(EgressEntities_k.Args.hull_frictions_out,              sector_buffer.get_buffer(BufferType.HULL_FRICTION))
            .buf_arg(EgressEntities_k.Args.hull_restitutions_out,           sector_buffer.get_buffer(BufferType.HULL_RESTITUTION))
            .buf_arg(EgressEntities_k.Args.hull_point_tables_out,           sector_buffer.get_buffer(BufferType.HULL_POINT_TABLE))
            .buf_arg(EgressEntities_k.Args.hull_edge_tables_out,            sector_buffer.get_buffer(BufferType.HULL_EDGE_TABLE))
            .buf_arg(EgressEntities_k.Args.hull_bone_tables_out,            sector_buffer.get_buffer(BufferType.HULL_BONE_TABLE))
            .buf_arg(EgressEntities_k.Args.hull_entity_ids_out,             sector_buffer.get_buffer(BufferType.HULL_ENTITY_ID))
            .buf_arg(EgressEntities_k.Args.hull_flags_out,                  sector_buffer.get_buffer(BufferType.HULL_FLAG))
            .buf_arg(EgressEntities_k.Args.hull_mesh_ids_out,               sector_buffer.get_buffer(BufferType.HULL_MESH_ID))
            .buf_arg(EgressEntities_k.Args.hull_uv_offsets_out,             sector_buffer.get_buffer(BufferType.HULL_UV_OFFSET))
            .buf_arg(EgressEntities_k.Args.hull_integrity_out,              sector_buffer.get_buffer(BufferType.HULL_INTEGRITY))
            .buf_arg(EgressEntities_k.Args.entities_out,                    sector_buffer.get_buffer(BufferType.ENTITY))
            .buf_arg(EgressEntities_k.Args.entity_animation_elapsed_out,    sector_buffer.get_buffer(BufferType.ENTITY_ANIM_ELAPSED))
            .buf_arg(EgressEntities_k.Args.entity_motion_states_out,        sector_buffer.get_buffer(BufferType.ENTITY_MOTION_STATE))
            .buf_arg(EgressEntities_k.Args.entity_animation_indices_out,    sector_buffer.get_buffer(BufferType.ENTITY_ANIM_INDEX))
            .buf_arg(EgressEntities_k.Args.entity_hull_tables_out,          sector_buffer.get_buffer(BufferType.ENTITY_HULL_TABLE))
            .buf_arg(EgressEntities_k.Args.entity_bone_tables_out,          sector_buffer.get_buffer(BufferType.ENTITY_BONE_TABLE))
            .buf_arg(EgressEntities_k.Args.entity_masses_out,               sector_buffer.get_buffer(BufferType.ENTITY_MASS))
            .buf_arg(EgressEntities_k.Args.entity_root_hulls_out,           sector_buffer.get_buffer(BufferType.ENTITY_ROOT_HULL))
            .buf_arg(EgressEntities_k.Args.entity_model_indices_out,        sector_buffer.get_buffer(BufferType.ENTITY_MODEL_ID))
            .buf_arg(EgressEntities_k.Args.entity_model_transforms_out,     sector_buffer.get_buffer(BufferType.ENTITY_TRANSFORM_ID))
            .buf_arg(EgressEntities_k.Args.entity_flags_out,                sector_buffer.get_buffer(BufferType.ENTITY_FLAG))
            .buf_arg(EgressEntities_k.Args.hull_bones_out,                  sector_buffer.get_buffer(BufferType.HULL_BONE))
            .buf_arg(EgressEntities_k.Args.hull_bind_pose_indicies_out,     sector_buffer.get_buffer(BufferType.HULL_BONE_BIND_POSE))
            .buf_arg(EgressEntities_k.Args.hull_inv_bind_pose_indicies_out, sector_buffer.get_buffer(BufferType.HULL_BONE_INV_BIND_POSE))
            .buf_arg(EgressEntities_k.Args.armature_bones_out,              sector_buffer.get_buffer(BufferType.ENTITY_BONE))
            .buf_arg(EgressEntities_k.Args.armature_bone_reference_ids_out, sector_buffer.get_buffer(BufferType.ENTITY_BONE_REFERENCE_ID))
            .buf_arg(EgressEntities_k.Args.armature_bone_parent_ids_out,    sector_buffer.get_buffer(BufferType.ENTITY_BONE_PARENT_ID))
