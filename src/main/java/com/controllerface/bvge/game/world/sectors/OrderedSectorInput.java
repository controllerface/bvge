...
public class OrderedSectorInput implements SectorContainer, Destoryable
{
    ...
    public OrderedSectorInput(long ptr_queue, GPUCoreMemory core_memory)
    {
        ...
        k_merge_point = new MergePoint_k(ptr_queue, k_ptr_merge_point)
            .buf_arg(MergePoint_k.Args.points_in, buffers.get_buffer(CoreBufferType.POINT))
            .buf_arg(MergePoint_k.Args.point_vertex_references_in, buffers.get_buffer(CoreBufferType.POINT_VERTEX_REFERENCE))
            .buf_arg(MergePoint_k.Args.point_hull_indices_in, buffers.get_buffer(CoreBufferType.POINT_HULL_INDEX))
            .buf_arg(MergePoint_k.Args.point_hit_counts_in, buffers.get_buffer(CoreBufferType.POINT_HIT_COUNT))
            .buf_arg(MergePoint_k.Args.point_flags_in, buffers.get_buffer(CoreBufferType.POINT_FLAG))
            .buf_arg(MergePoint_k.Args.point_bone_tables_in, buffers.get_buffer(CoreBufferType.POINT_BONE_TABLE))
        ...
        k_merge_edge = new MergeEdge_k(ptr_queue, k_ptr_merge_edge)
            .buf_arg(MergeEdge_k.Args.edges_in, buffers.get_buffer(CoreBufferType.EDGE))
            .buf_arg(MergeEdge_k.Args.edge_lengths_in, buffers.get_buffer(CoreBufferType.EDGE_LENGTH))
            .buf_arg(MergeEdge_k.Args.edge_flags_in, buffers.get_buffer(CoreBufferType.EDGE_FLAG))
        ...
        k_merge_hull = new MergeHull_k(ptr_queue, k_ptr_merge_hull)
            .buf_arg(MergeHull_k.Args.hulls_in, buffers.get_buffer(CoreBufferType.HULL))
            .buf_arg(MergeHull_k.Args.hull_scales_in, buffers.get_buffer(CoreBufferType.HULL_SCALE))
            .buf_arg(MergeHull_k.Args.hull_rotations_in, buffers.get_buffer(CoreBufferType.HULL_ROTATION))
            .buf_arg(MergeHull_k.Args.hull_frictions_in, buffers.get_buffer(CoreBufferType.HULL_FRICTION))
            .buf_arg(MergeHull_k.Args.hull_restitutions_in, buffers.get_buffer(CoreBufferType.HULL_RESTITUTION))
            .buf_arg(MergeHull_k.Args.hull_point_tables_in, buffers.get_buffer(CoreBufferType.HULL_POINT_TABLE))
            .buf_arg(MergeHull_k.Args.hull_edge_tables_in, buffers.get_buffer(CoreBufferType.HULL_EDGE_TABLE))
            .buf_arg(MergeHull_k.Args.hull_bone_tables_in, buffers.get_buffer(CoreBufferType.HULL_BONE_TABLE))
            .buf_arg(MergeHull_k.Args.hull_entity_ids_in, buffers.get_buffer(CoreBufferType.HULL_ENTITY_ID))
            .buf_arg(MergeHull_k.Args.hull_flags_in, buffers.get_buffer(CoreBufferType.HULL_FLAG))
            .buf_arg(MergeHull_k.Args.hull_mesh_ids_in, buffers.get_buffer(CoreBufferType.HULL_MESH_ID))
            .buf_arg(MergeHull_k.Args.hull_uv_offsets_in, buffers.get_buffer(CoreBufferType.HULL_UV_OFFSET))
            .buf_arg(MergeHull_k.Args.hull_integrity_in, buffers.get_buffer(CoreBufferType.HULL_INTEGRITY))
        ...
        k_merge_entity = new MergeEntity_k(ptr_queue, k_ptr_merge_entity)
            .buf_arg(MergeEntity_k.Args.entities_in, buffers.get_buffer(CoreBufferType.ENTITY))
            .buf_arg(MergeEntity_k.Args.entity_animation_elapsed_in, buffers.get_buffer(CoreBufferType.ENTITY_ANIM_ELAPSED))
            .buf_arg(MergeEntity_k.Args.entity_motion_states_in, buffers.get_buffer(CoreBufferType.ENTITY_MOTION_STATE))
            .buf_arg(MergeEntity_k.Args.entity_animation_indices_in, buffers.get_buffer(CoreBufferType.ENTITY_ANIM_INDEX))
            .buf_arg(MergeEntity_k.Args.entity_hull_tables_in, buffers.get_buffer(CoreBufferType.ENTITY_HULL_TABLE))
            .buf_arg(MergeEntity_k.Args.entity_bone_tables_in, buffers.get_buffer(CoreBufferType.ENTITY_BONE_TABLE))
            .buf_arg(MergeEntity_k.Args.entity_masses_in, buffers.get_buffer(CoreBufferType.ENTITY_MASS))
            .buf_arg(MergeEntity_k.Args.entity_root_hulls_in, buffers.get_buffer(CoreBufferType.ENTITY_ROOT_HULL))
            .buf_arg(MergeEntity_k.Args.entity_model_indices_in, buffers.get_buffer(CoreBufferType.ENTITY_MODEL_ID))
            .buf_arg(MergeEntity_k.Args.entity_model_transforms_in, buffers.get_buffer(CoreBufferType.ENTITY_TRANSFORM_ID))
            .buf_arg(MergeEntity_k.Args.entity_types_in, buffers.get_buffer(CoreBufferType.ENTITY_TYPE))
            .buf_arg(MergeEntity_k.Args.entity_flags_in, buffers.get_buffer(CoreBufferType.ENTITY_FLAG))
            ...
            .buf_arg(MergeEntity_k.Args.entity_animation_indices_out, core_memory.get_buffer(CoreBufferType.ENTITY_ANIM_INDEX))
        ...
        k_merge_hull_bone = new MergeHullBone_k(ptr_queue, k_ptr_merge_hull_bone)
            .buf_arg(MergeHullBone_k.Args.hull_bones_in, buffers.get_buffer(CoreBufferType.HULL_BONE))
            .buf_arg(MergeHullBone_k.Args.hull_bind_pose_indicies_in, buffers.get_buffer(CoreBufferType.HULL_BONE_BIND_POSE))
            .buf_arg(MergeHullBone_k.Args.hull_inv_bind_pose_indicies_in, buffers.get_buffer(CoreBufferType.HULL_BONE_INV_BIND_POSE))
        ...
        k_merge_entity_bone = new MergeEntityBone_k(ptr_queue, k_ptr_merge_entity_bone)
            .buf_arg(MergeEntityBone_k.Args.armature_bones_in, buffers.get_buffer(CoreBufferType.ENTITY_BONE))
            .buf_arg(MergeEntityBone_k.Args.armature_bone_reference_ids_in, buffers.get_buffer(CoreBufferType.ENTITY_BONE_REFERENCE_ID))
            .buf_arg(MergeEntityBone_k.Args.armature_bone_parent_ids_in, buffers.get_buffer(CoreBufferType.ENTITY_BONE_PARENT_ID))
