...
public class SectorCompactor implements Destoryable
{
                           ...
                           long delete_init)
    {
        ...
        k_compact_entities = new CompactEntities_k(ptr_queue, k_ptr_compact_entities)
            ...
            .buf_arg(CompactEntities_k.Args.entity_animation_indices, sector_buffers.buffer(ENTITY_ANIM_INDEX))
        ...
        k_compact_edges = new CompactEdges_k(ptr_queue, k_ptr_compact_edges)
            ...
            .buf_arg(CompactEdges_k.Args.edge_aabb, sector_buffers.buffer(EDGE_AABB))
            .buf_arg(CompactEdges_k.Args.edge_aabb_index, sector_buffers.buffer(EDGE_AABB_INDEX))
            .buf_arg(CompactEdges_k.Args.edge_aabb_key_table, sector_buffers.buffer(EDGE_AABB_KEY_TABLE));
