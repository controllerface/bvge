...
public class UnorderedSectorOutput
{
    ...
    public UnorderedSectorOutput(String name, long ptr_queue, GPUCoreMemory core_memory)
    {
        ...
        k_egress_entities = new EgressEntities_k(this.ptr_queue, k_ptr_egress_candidates)
            ...
            .buf_arg(EgressEntities_k.Args.entity_types_in,                 core_memory.buffer(ENTITY_TYPE))
            ...
            .buf_arg(EgressEntities_k.Args.points_out,                      sector_group.get_buffer(POINT))
            .buf_arg(EgressEntities_k.Args.point_vertex_references_out,     sector_group.get_buffer(POINT_VERTEX_REFERENCE))
            .buf_arg(EgressEntities_k.Args.point_hull_indices_out,          sector_group.get_buffer(POINT_HULL_INDEX))
            .buf_arg(EgressEntities_k.Args.point_hit_counts_out,            sector_group.get_buffer(POINT_HIT_COUNT))
            .buf_arg(EgressEntities_k.Args.point_flags_out,                 sector_group.get_buffer(POINT_FLAG))
            .buf_arg(EgressEntities_k.Args.point_bone_tables_out,           sector_group.get_buffer(POINT_BONE_TABLE))
            .buf_arg(EgressEntities_k.Args.edges_out,                       sector_group.get_buffer(EDGE))
            .buf_arg(EgressEntities_k.Args.edge_lengths_out,                sector_group.get_buffer(EDGE_LENGTH))
            .buf_arg(EgressEntities_k.Args.edge_flags_out,                  sector_group.get_buffer(EDGE_FLAG))
            .buf_arg(EgressEntities_k.Args.hulls_out,                       sector_group.get_buffer(HULL))
            .buf_arg(EgressEntities_k.Args.hull_scales_out,                 sector_group.get_buffer(HULL_SCALE))
            .buf_arg(EgressEntities_k.Args.hull_rotations_out,              sector_group.get_buffer(HULL_ROTATION))
            .buf_arg(EgressEntities_k.Args.hull_frictions_out,              sector_group.get_buffer(HULL_FRICTION))
            .buf_arg(EgressEntities_k.Args.hull_restitutions_out,           sector_group.get_buffer(HULL_RESTITUTION))
            .buf_arg(EgressEntities_k.Args.hull_point_tables_out,           sector_group.get_buffer(HULL_POINT_TABLE))
            .buf_arg(EgressEntities_k.Args.hull_edge_tables_out,            sector_group.get_buffer(HULL_EDGE_TABLE))
            .buf_arg(EgressEntities_k.Args.hull_bone_tables_out,            sector_group.get_buffer(HULL_BONE_TABLE))
            .buf_arg(EgressEntities_k.Args.hull_entity_ids_out,             sector_group.get_buffer(HULL_ENTITY_ID))
            .buf_arg(EgressEntities_k.Args.hull_flags_out,                  sector_group.get_buffer(HULL_FLAG))
            .buf_arg(EgressEntities_k.Args.hull_mesh_ids_out,               sector_group.get_buffer(HULL_MESH_ID))
            .buf_arg(EgressEntities_k.Args.hull_uv_offsets_out,             sector_group.get_buffer(HULL_UV_OFFSET))
            .buf_arg(EgressEntities_k.Args.hull_integrity_out,              sector_group.get_buffer(HULL_INTEGRITY))
            .buf_arg(EgressEntities_k.Args.entities_out,                    sector_group.get_buffer(ENTITY))
            .buf_arg(EgressEntities_k.Args.entity_animation_elapsed_out,    sector_group.get_buffer(ENTITY_ANIM_ELAPSED))
            .buf_arg(EgressEntities_k.Args.entity_motion_states_out,        sector_group.get_buffer(ENTITY_MOTION_STATE))
            .buf_arg(EgressEntities_k.Args.entity_animation_indices_out,    sector_group.get_buffer(ENTITY_ANIM_INDEX))
            .buf_arg(EgressEntities_k.Args.entity_hull_tables_out,          sector_group.get_buffer(ENTITY_HULL_TABLE))
            .buf_arg(EgressEntities_k.Args.entity_bone_tables_out,          sector_group.get_buffer(ENTITY_BONE_TABLE))
            .buf_arg(EgressEntities_k.Args.entity_masses_out,               sector_group.get_buffer(ENTITY_MASS))
            .buf_arg(EgressEntities_k.Args.entity_root_hulls_out,           sector_group.get_buffer(ENTITY_ROOT_HULL))
            .buf_arg(EgressEntities_k.Args.entity_model_indices_out,        sector_group.get_buffer(ENTITY_MODEL_ID))
            .buf_arg(EgressEntities_k.Args.entity_model_transforms_out,     sector_group.get_buffer(ENTITY_TRANSFORM_ID))
            .buf_arg(EgressEntities_k.Args.entity_types_out,                sector_group.get_buffer(ENTITY_TYPE))
            .buf_arg(EgressEntities_k.Args.entity_flags_out,                sector_group.get_buffer(ENTITY_FLAG))
            .buf_arg(EgressEntities_k.Args.hull_bones_out,                  sector_group.get_buffer(HULL_BONE))
            .buf_arg(EgressEntities_k.Args.hull_bind_pose_indicies_out,     sector_group.get_buffer(HULL_BONE_BIND_POSE))
            .buf_arg(EgressEntities_k.Args.hull_inv_bind_pose_indicies_out, sector_group.get_buffer(HULL_BONE_INV_BIND_POSE))
            .buf_arg(EgressEntities_k.Args.armature_bones_out,              sector_group.get_buffer(ENTITY_BONE))
            .buf_arg(EgressEntities_k.Args.armature_bone_reference_ids_out, sector_group.get_buffer(ENTITY_BONE_REFERENCE_ID))
            .buf_arg(EgressEntities_k.Args.armature_bone_parent_ids_out,    sector_group.get_buffer(ENTITY_BONE_PARENT_ID))
