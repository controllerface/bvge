...
public class UnorderedSectorOutput implements Destoryable
{
                                 ...
                                 long point_init)
    {
        ...
        k_egress_entities = new EgressEntities_k(this.ptr_queue, k_ptr_egress_entities)
            .buf_arg(EgressEntities_k.Args.points_in,                       this.core_memory.get_buffer(POINT))
            .buf_arg(EgressEntities_k.Args.point_vertex_references_in,      this.core_memory.get_buffer(POINT_VERTEX_REFERENCE))
            .buf_arg(EgressEntities_k.Args.point_hull_indices_in,           this.core_memory.get_buffer(POINT_HULL_INDEX))
            .buf_arg(EgressEntities_k.Args.point_hit_counts_in,             this.core_memory.get_buffer(POINT_HIT_COUNT))
            .buf_arg(EgressEntities_k.Args.point_flags_in,                  this.core_memory.get_buffer(POINT_FLAG))
            ...
            .buf_arg(EgressEntities_k.Args.edge_lengths_in,                 this.core_memory.get_buffer(EDGE_LENGTH))
            .buf_arg(EgressEntities_k.Args.edge_flags_in,                   this.core_memory.get_buffer(EDGE_FLAG))
            .buf_arg(EgressEntities_k.Args.hulls_in,                        this.core_memory.get_buffer(HULL))
            .buf_arg(EgressEntities_k.Args.hull_scales_in,                  this.core_memory.get_buffer(HULL_SCALE))
            .buf_arg(EgressEntities_k.Args.hull_rotations_in,               this.core_memory.get_buffer(HULL_ROTATION))
            .buf_arg(EgressEntities_k.Args.hull_frictions_in,               this.core_memory.get_buffer(HULL_FRICTION))
            .buf_arg(EgressEntities_k.Args.hull_restitutions_in,            this.core_memory.get_buffer(HULL_RESTITUTION))
            ...
            .buf_arg(EgressEntities_k.Args.hull_entity_ids_in,              this.core_memory.get_buffer(HULL_ENTITY_ID))
            .buf_arg(EgressEntities_k.Args.hull_flags_in,                   this.core_memory.get_buffer(HULL_FLAG))
            .buf_arg(EgressEntities_k.Args.hull_mesh_ids_in,                this.core_memory.get_buffer(HULL_MESH_ID))
            .buf_arg(EgressEntities_k.Args.hull_uv_offsets_in,              this.core_memory.get_buffer(HULL_UV_OFFSET))
            .buf_arg(EgressEntities_k.Args.hull_integrity_in,               this.core_memory.get_buffer(HULL_INTEGRITY))
            ...
            .buf_arg(EgressEntities_k.Args.hull_bones_in,                   this.core_memory.get_buffer(HULL_BONE))
            .buf_arg(EgressEntities_k.Args.hull_bind_pose_indicies_in,      this.core_memory.get_buffer(HULL_BONE_BIND_POSE))
            .buf_arg(EgressEntities_k.Args.hull_inv_bind_pose_indicies_in,  this.core_memory.get_buffer(HULL_BONE_INV_BIND_POSE))
            .buf_arg(EgressEntities_k.Args.entity_bones_in,                 this.core_memory.get_buffer(ENTITY_BONE))
            .buf_arg(EgressEntities_k.Args.entity_bone_reference_ids_in,    this.core_memory.get_buffer(ENTITY_BONE_REFERENCE_ID))
            ...
            .buf_arg(EgressEntities_k.Args.entity_bones_out,                sector_buffers.get_buffer(ENTITY_BONE))
            .buf_arg(EgressEntities_k.Args.entity_bone_reference_ids_out,   sector_buffers.get_buffer(ENTITY_BONE_REFERENCE_ID))
            .buf_arg(EgressEntities_k.Args.entity_bone_parent_ids_out,      sector_buffers.get_buffer(ENTITY_BONE_PARENT_ID))
        ...
        k_egress_hulls = new EgressHulls_k(this.ptr_queue, k_ptr_egress_hulls)
            ...
            .buf_arg(EgressHulls_k.Args.hulls_out,                       sector_buffers.get_buffer(HULL))
            .buf_arg(EgressHulls_k.Args.hull_scales_out,                 sector_buffers.get_buffer(HULL_SCALE))
            .buf_arg(EgressHulls_k.Args.hull_rotations_out,              sector_buffers.get_buffer(HULL_ROTATION))
            .buf_arg(EgressHulls_k.Args.hull_frictions_out,              sector_buffers.get_buffer(HULL_FRICTION))
            .buf_arg(EgressHulls_k.Args.hull_restitutions_out,           sector_buffers.get_buffer(HULL_RESTITUTION))
            .buf_arg(EgressHulls_k.Args.hull_point_tables_out,           sector_buffers.get_buffer(HULL_POINT_TABLE))
            .buf_arg(EgressHulls_k.Args.hull_edge_tables_out,            sector_buffers.get_buffer(HULL_EDGE_TABLE))
            .buf_arg(EgressHulls_k.Args.hull_bone_tables_out,            sector_buffers.get_buffer(HULL_BONE_TABLE))
            .buf_arg(EgressHulls_k.Args.hull_entity_ids_out,             sector_buffers.get_buffer(HULL_ENTITY_ID))
            .buf_arg(EgressHulls_k.Args.hull_flags_out,                  sector_buffers.get_buffer(HULL_FLAG))
            .buf_arg(EgressHulls_k.Args.hull_mesh_ids_out,               sector_buffers.get_buffer(HULL_MESH_ID))
            .buf_arg(EgressHulls_k.Args.hull_uv_offsets_out,             sector_buffers.get_buffer(HULL_UV_OFFSET))
            .buf_arg(EgressHulls_k.Args.hull_integrity_out,              sector_buffers.get_buffer(HULL_INTEGRITY))
        ...
        k_egress_edges = new EgressEdges_k(this.ptr_queue, k_ptr_egress_edges)
            ...
            .buf_arg(EgressEdges_k.Args.edges_out,                       sector_buffers.get_buffer(EDGE))
            .buf_arg(EgressEdges_k.Args.edge_lengths_out,                sector_buffers.get_buffer(EDGE_LENGTH))
            .buf_arg(EgressEdges_k.Args.edge_flags_out,                  sector_buffers.get_buffer(EDGE_FLAG))
        ...
        k_egress_points = new EgressPoints_k(this.ptr_queue, k_ptr_egress_points)
            ...
            .buf_arg(EgressPoints_k.Args.points_out,                      sector_buffers.get_buffer(POINT))
            .buf_arg(EgressPoints_k.Args.point_vertex_references_out,     sector_buffers.get_buffer(POINT_VERTEX_REFERENCE))
            .buf_arg(EgressPoints_k.Args.point_hull_indices_out,          sector_buffers.get_buffer(POINT_HULL_INDEX))
            .buf_arg(EgressPoints_k.Args.point_hit_counts_out,            sector_buffers.get_buffer(POINT_HIT_COUNT))
            .buf_arg(EgressPoints_k.Args.point_flags_out,                 sector_buffers.get_buffer(POINT_FLAG))
            .buf_arg(EgressPoints_k.Args.point_bone_tables_out,           sector_buffers.get_buffer(POINT_BONE_TABLE))
        ...
        k_egress_hull_bones = new EgressHullBones_k(this.ptr_queue, k_ptr_egress_hull_bones)
            ...
            .buf_arg(EgressHullBones_k.Args.hull_bones_out,                  sector_buffers.get_buffer(HULL_BONE))
            .buf_arg(EgressHullBones_k.Args.hull_bind_pose_indicies_out,     sector_buffers.get_buffer(HULL_BONE_BIND_POSE))
            .buf_arg(EgressHullBones_k.Args.hull_inv_bind_pose_indicies_out, sector_buffers.get_buffer(HULL_BONE_INV_BIND_POSE))
        ...
        k_egress_entity_bones = new EgressEntityBones_k(this.ptr_queue, k_ptr_egress_entity_bones)
            ...
            .buf_arg(EgressEntityBones_k.Args.entity_bones_out,              sector_buffers.get_buffer(ENTITY_BONE))
            .buf_arg(EgressEntityBones_k.Args.entity_bone_reference_ids_out, sector_buffers.get_buffer(ENTITY_BONE_REFERENCE_ID))
            .buf_arg(EgressEntityBones_k.Args.entity_bone_parent_ids_out,    sector_buffers.get_buffer(ENTITY_BONE_PARENT_ID))
