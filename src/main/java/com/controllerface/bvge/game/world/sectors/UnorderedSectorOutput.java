...
public class UnorderedSectorOutput implements Destroyable
{
                                 ...
                                 long point_init)
    {
        ...
        k_egress_entities = new EgressEntities_k(this.ptr_queue, k_ptr_egress_entities)
            ...
            .buf_arg(EgressEntities_k.Args.entity_animation_previous_in,    this.core_memory.get_buffer(ENTITY_ANIM_PREVIOUS))
            ...
            .buf_arg(EgressEntities_k.Args.entity_animation_previous_out,   sector_buffers.buffer(ENTITY_ANIM_PREVIOUS))
