...
public class CoreBufferGroup extends BufferGroup<CoreBufferType>
{
    ...
    {
        super(cmd_queue, CoreBufferType.class, name, true);
        ...
        init_buffer(EDGE_PIN,            edge_init);
    ...
    public void ensure_edge_capacity(int edge_capacity)
    {
        ...
        buffer(EDGE_PIN).ensure_capacity(edge_capacity);
    }
