 ...
 */
public class BoxRenderBatch implements Comparable<BoxRenderBatch>
{
    // Vertex
    // ======
    ...
    public BoxRenderBatch(int zIndex, Shader currentShader)
    {
        this.zIndex = zIndex;
...
//    }
    ...
    @Override
    public int compareTo(BoxRenderBatch o)
    {
