...
public class PhysicsSimulation extends GameSystem
{
    ...
    private void tick_simulation()
    {
        ...
        */
        ...
        System.out.println("bank offsets calculated: " + uniform_grid.key_bank_size);
        ...
        System.out.println("key map size calculated");
        ...
        System.out.println("key map built");
        ...
        locate_in_bounds();
        System.out.println("in-bounds objects located");
        ...
        System.out.println("match candidates calculated: " + candidate_buffer_count);
        ...
        System.out.println("match offsets calculated: " + match_buffer_count);
        ...
        aabb_collide();
        System.out.println("AABB collision finished");
        ...
        finalize_candidates();
        System.out.println("AABB candidates finalized");
        ...
        */
        ...
        sat_collide();
        System.out.println("SAT collision finished");
        ...
        scan_reactions();
        System.out.println("reactions scanned");
        ...
        sort_reactions();
        System.out.println("reactions sorted");
        ...
        apply_reactions();
        System.out.println("reactions applied");
        ...
        move_armatures();
        System.out.println("armatures updated");
    }
