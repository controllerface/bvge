...
{
    private static final String kernel_name = "create_entity";
    ...
    public static String cl_kernel()
    {
        ...
        {
            kernel_source = CLUtils.generate_crud_kernel_header(Args.target.ordinal(), kernel_name, Args.class, Args.type_map);
        }
