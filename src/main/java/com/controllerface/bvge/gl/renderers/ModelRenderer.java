...
public class ModelRenderer extends GameSystem
{
    ...
    private void init_CL()
    {
        ...
        counters_ptr = GPGPU.new_empty_buffer(GPGPU.render_command_queue_ptr, mesh_size);
        offsets_ptr = GPGPU.new_empty_buffer(GPGPU.render_command_queue_ptr, mesh_size);
        mesh_transfer_ptr = GPGPU.new_empty_buffer(GPGPU.render_command_queue_ptr, ELEMENT_BUFFER_SIZE * 2);
        ...
        count_mesh_instances_k = new CountMeshInstances_k(GPGPU.render_command_queue_ptr, count_instances_k_ptr)
        ...
        write_mesh_details_k = new WriteMeshDetails_k(GPGPU.render_command_queue_ptr, write_details_k_ptr)
        ...
        count_mesh_batches_k = new CountMeshBatches_k(GPGPU.render_command_queue_ptr, count_batches_k_ptr)
        ...
        calculate_batch_offsets_k = new CalculateBatchOffsets_k(GPGPU.render_command_queue_ptr, calc_offsets_k_ptr);

        long transfer_detail_k_ptr = mesh_query_p.kernel_ptr(Kernel.transfer_detail_data);
        transfer_detail_data_k = new TransferDetailData_k(GPGPU.render_command_queue_ptr, transfer_detail_k_ptr)
        ...
        transfer_render_data_k = new TransferRenderData_k(GPGPU.render_command_queue_ptr, transfer_render_k_ptr)
        ...
        scan_int_single_block_k = new ScanIntSingleBlock_k(GPGPU.render_command_queue_ptr, scan_int_array_single_ptr);
        scan_int_multi_block_k = new ScanIntMultiBlock_k(GPGPU.render_command_queue_ptr, scan_int_array_multi_ptr);
        complete_int_multi_block_k = new CompleteIntMultiBlock_k(GPGPU.render_command_queue_ptr, scan_int_array_comp_ptr);
        ...
        scan_int2_single_block_k = new ScanInt2SingleBlock_k(GPGPU.render_command_queue_ptr, scan_int2_array_single_ptr);
        scan_int2_multi_block_k = new ScanInt2MultiBlock_k(GPGPU.render_command_queue_ptr, scan_int2_array_multi_ptr);
        complete_int2_multi_block_k = new CompleteInt2MultiBlock_k(GPGPU.render_command_queue_ptr, scan_int2_array_comp_ptr);
        ...
        scan_int_single_block_out_k = new ScanIntSingleBlockOut_k(GPGPU.render_command_queue_ptr, scan_int_array_out_single_ptr);
        scan_int_multi_block_out_k = new ScanIntMultiBlockOut_k(GPGPU.render_command_queue_ptr, scan_int_array_out_multi_ptr);
        complete_int_multi_block_out_k = new CompleteIntMultiBlockOut_k(GPGPU.render_command_queue_ptr, scan_int_array_out_comp_ptr);
    }

    @Override
    public void tick(float dt)
    {
        GPGPU.cl_zero_buffer(GPGPU.render_command_queue_ptr, counters_ptr, mesh_size);
        GPGPU.cl_zero_buffer(GPGPU.render_command_queue_ptr, offsets_ptr, mesh_size);
        GPGPU.cl_zero_buffer(GPGPU.render_command_queue_ptr, total_ptr, CLSize.cl_int);
        GPGPU.cl_zero_buffer(GPGPU.render_command_queue_ptr, mesh_transfer_ptr, ELEMENT_BUFFER_SIZE * 2);
        ...
        int total_instances = GPGPU.cl_read_pinned_int(GPGPU.render_command_queue_ptr, total_ptr);
        ...
        var mesh_details_ptr = GPGPU.new_empty_buffer(GPGPU.render_command_queue_ptr, data_size);
        ...
        int total_batches = GPGPU.cl_read_pinned_int(GPGPU.render_command_queue_ptr, total_ptr);
        long batch_index_size = (long) total_batches * CLSize.cl_int;

        var mesh_offset_ptr = GPGPU.new_empty_buffer(GPGPU.render_command_queue_ptr, batch_index_size);
        ...
        GPGPU.cl_read_buffer(GPGPU.render_command_queue_ptr, mesh_offset_ptr, raw_offsets);
