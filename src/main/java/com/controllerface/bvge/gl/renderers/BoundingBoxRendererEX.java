...
import com.controllerface.bvge.cl.kernels.rendering.PrepareBounds_k;
...
public class BoundingBoxRendererEX extends GameSystem
{
    ...
    public BoundingBoxRendererEX(ECS ecs)
    {
        super(ecs);
    ...
    {
        shader = Assets.load_shader("bounding_outline_point.glsl");
