...
public class HumanoidRenderer extends GameSystem
{
    ...
    {
        command_buffer_ptr = GPU.share_memory(cbo);
        element_buffer_ptr = GPU.share_memory(ebo);
        vertex_buffer_ptr = GPU.share_memory(vbo);
        uv_buffer_ptr = GPU.share_memory(uvo);
